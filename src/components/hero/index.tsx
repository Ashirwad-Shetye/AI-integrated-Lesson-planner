    ...
    <div className="relative h-3/6">
      ...
      <div className="flex">
        <div className="relative h-80 w-full lg:w-8/12">
          <div
            className="relative mx-10 h-80 md:h-72 flex flex-col justify-center bg-white space-y-5 font-roboSlab w-10/12 lg:w-8/12
          ...
          <div
            className={`h-80 md:h-72 absolute top-2 left-2 mx-10 bg-black w-10/12 lg:w-8/12 z-0`}
          ></div>
        </div>
        <div className="hidden lg:block w-fit border-2">
